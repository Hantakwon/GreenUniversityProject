									...
									<div class="b-paging-wrap">
										<ul>
											<li class="first pager"><a
												href="/admission/consult/search.do?page=1"> <img
													src="${pageContext.request.contextPath}/resources/images/btn-first-page.png" alt="" /> <span
													class="hide">FIRST</span>
											</a></li>

											<li class="prev pager"><a
												href="/admission/consult/search.do?page=${pagenationDTO.currentPage le 1 ? 1 : pagenationDTO.currentPage - 1}">
													<img src="${pageContext.request.contextPath}/resources/images/btn-prev-page.png" alt="" />
											...
											<c:forEach var="num" begin="${pagenationDTO.pageGroupStart}"
												...
												<li><a
													href="${pageContext.request.contextPath}/admission/consult/search.do?page=${num}"
													class="${pagenationDTO.currentPage eq num ? ' active' : ''}">
														${num} </a></li>
											</c:forEach>

											<li class="next pager"><a
												href="/admission/consult/search.do?page=${pagenationDTO.currentPage ge pagenationDTO.lastPageNum ? pagenationDTO.lastPageNum : pagenationDTO.currentPage + 1}">
													<img src="${pageContext.request.contextPath}/resources/images/btn-next-page.png" alt="" />
													<span class="hide">NEXT</span>
											</a></li>
											<li class="last pager"><a
												href="/admission/consult/search.do?page=${pagenationDTO.lastPageNum}">
													<img src="${pageContext.request.contextPath}/resources/images/btn-last-page.png" alt="" />
