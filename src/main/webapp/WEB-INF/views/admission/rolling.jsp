...
<link rel="stylesheet" href="<%=request.getContextPath()%>/resources/css/admission/rolling.css">
</head>
<!--
	날짜 : 2025/09/05
    이름 : 한탁원
		...
		<div class="lnb-wrap">
			<div class="lnb">
				...
				<ul class="lnb-menu jwxe-menu-ul">
					...
					<li class="active"><a href="/admission/rolling.do" class="active">수시모집</a></li>
...
<<<<<<< HEAD
					            <h3>2026학년도 수시 신입생 모집 원서접수 안내</h3>
=======
					            <h3>2026학년도 수시 신입생모집 원서접수 안내</h3>
>>>>>>> main
