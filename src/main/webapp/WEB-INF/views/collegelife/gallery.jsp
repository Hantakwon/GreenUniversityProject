...
<body>
    ...
    <jsp:include page="../header.jsp" />
        ...
        <div>
            <div class="info">
                <span id="test">
                    <img src="<%=request.getContextPath()%>/resources/images/ico-home.png" alt="홈버튼">
                    > 대학생활 > 갤러리
                </span>
            </div>
        </div>
                        ...
                        <div class="gallery-container">
                            ...
                            <c:forEach var="item" items="${galleryList}">
                                <div class="gallery-item">
                                    <div class="img-box">
                                        <img src="<%=request.getContextPath()%><c:out value='${item.image_path}'/>"
                                             alt="${item.title}">
                                    </div>
                                    <div class="text-box">
                                        <p class="title">${item.title}</p>
                                        <div class="details">
                                            <span class="view-count">조회수 ${item.rdcnt}</span>
                        ...
                        <div class="page-wrapper">
                            <div class="page">
                                ...
                                <c:if test="${currentPage > 1}">
                                    <a href="gallery.do?page=${currentPage - 1}">
                                ...
                                <!-- 마지막 페이지 -->
                                <a href="gallery.do?page=${lastPageNum}">
