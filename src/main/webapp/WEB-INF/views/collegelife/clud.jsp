...
<!-- 
	날짜 : 2025/09/11 
	이름 : 박효빈
	내용 : 동아리/스터디 / 정적페이지로 임의 내용 추가 (grade.jsp 형식 반영)
-->
<!--
    날짜 : 2025/09/11
    이름 : 정순권
				...
				<div class="main-content">
					...
					<div class="bold-ment">
						...
						<div class="ment1">
							...
							1) **학술 동아리**: 전공 심화 학습, 공모전 준비, 스터디 등<br>
							2) **문화예술 동아리**: 밴드, 댄스, 영화, 연극, 그림 등<br>
							3) **체육 동아리**: 농구, 축구, 배드민턴, 볼링 등<br>
							4) **봉사 동아리**: 지역사회 봉사, 재능 기부, 환경 캠페인 등<br>
							5) **어학 동아리**: 외국어 회화 스터디, 언어 교환 등<br><br>
							
							<span class="bold-span-highlight">- 동아리 가입 방법</span><br>
							1) **동아리 박람회**: 매 학기 초 교내에서 진행되는 동아리 박람회에서 각 동아리 부스를 방문하여 정보 확인 및 현장 가입<br>
					...
					<div class="bold-ment">
						...
						<div class="ment1">
							...
							4) **심사 및 인준**: 제출된 서류 및 면접 심사를 거쳐 최종 인준<br>
