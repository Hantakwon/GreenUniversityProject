...
-->
<link rel="stylesheet"
	href="<%=request.getContextPath()%>/resources/css/academic/academic.css">
		...
		<div>
			<div class="content-wrapper">
				<div class="sidebar">
					...
					<div class="bottom">
						<ul>
							<li class="active"><a href="/collegelife/studentunion.do">학생회
									소개</a></li>
				...
				<div class="main-content">
					...
					<div class="bold-ment">
						...
						<div class="ment1">
							...
							<span class="bold-span-highlight">- 내용 추가 필요</span> 1) 내용 추가 필요<br>
							2) 내용 추가 필요<br> 3) 내용 추가 필요<br> <br>
